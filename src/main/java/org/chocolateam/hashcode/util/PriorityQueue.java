...
public class PriorityQueue<E> extends AbstractQueue<E> implements java.io.Serializable {
     ...
     *
     * @param comparator
     *         the comparator that will be used to order this priority queue.  If {@code null}, the {@linkplain
     ...
     *
     * @throws ClassCastException
     *         if elements of {@code c} cannot be compared to one another according to {@code c}'s ordering
     * @throws NullPointerException
     ...
     *
     * @throws ClassCastException
     *         if elements of the specified sorted set cannot be compared to one another according to the sorted set's
     *         ordering
     * @throws NullPointerException
     ...
     * @throws ClassCastException
     *         if the specified element cannot be compared with elements currently in this priority queue according to
     ...
     *
     * @return the comparator used to order this queue, or {@code null} if this queue is sorted according to the natural
     ...
     *         the stream
     *
     * @serialData The length of the array backing the instance is emitted (int), followed by all of its elements (each
     * an {@code Object}) in the proper order.
     */
